...
`省份`、`链接`、`备注`、`报名状态`、`距截止天数`、`细分类别`、`笔试科目`、`限户籍`、
`限专业`、`学历要求`、`限应届`、`服务期`、`本校可报`。公开秋招表字段为：`公司名称`（主字段）、`日期`、`企业性质`、
...
“本校可报”是院校层面的快速初筛，不替代公告中的专业、学历、政治面貌等资格复核。例如河北
2026 定向选调中，东北林业大学仅林业工程、林学在院校（学科）名单内，用户仍须打开公告核对。
